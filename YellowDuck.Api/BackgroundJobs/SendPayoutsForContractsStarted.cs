    ...
    public class SendPayoutsForContractsStarted
    {
        ...
        public async Task Run()
        {
            ...
            foreach (var contract in contracts)
            {
                ...
                var body = $"Un paiement de {contract.Price.ToString("N2")} $ CA est en route vers le compte en banque du propriétaire. Un délai maximum de sept jours est attendu. Si suite à ce délai l'argent n'est toujours pas déposé, veuillez entrer en communication à l'adresse suivante mutuali@cibim.org";
