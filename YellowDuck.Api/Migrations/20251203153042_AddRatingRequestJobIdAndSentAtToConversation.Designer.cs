...
namespace YellowDuck.Api.Migrations
{
    ...
    [Migration("20251203153042_AddRatingRequestJobIdAndSentAtToConversation")]
    partial class AddRatingRequestJobIdAndSentAtToConversation
    {
            ...
            modelBuilder.Entity("YellowDuck.Api.DbModel.Entities.Conversations.Conversation", b =>
                {
                    ...
                    b.Property<string>("RatingRequestJobId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("RatingRequestSentAt")
                        .HasColumnType("datetime2");
