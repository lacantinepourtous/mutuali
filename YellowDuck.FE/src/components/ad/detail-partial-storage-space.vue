<template>
  <div>
    ...
    <div v-if="haveHtmlContent(ad.translationOrDefault.surfaceSize)" class="border-top border-grey py-6">
    ...
    <div v-if="haveHtmlContent(ad.translationOrDefault.equipment)" class="border-top border-grey py-6">
